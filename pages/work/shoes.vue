<template>
	<section>
		<specific-work :title="$options.workPreview.title" :showTitle="false" :text="text" :vid="vid" :img="img" />
	</section>
</template>
...
export default {
	...
	data () {
		return {
			...
			vid: '2UR-cXaQv4Y',
			img: [
				'/img/work/shoes/1.jpg',
				'/img/work/shoes/2.jpg',
				'/img/work/shoes/3.jpg'
